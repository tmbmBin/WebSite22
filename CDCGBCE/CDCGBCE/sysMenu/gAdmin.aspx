...
<script runat="server">
	...
	Function get_MenuBase() As System.Data.IDataReader
		...
		Dim queryString As String = "SELECT [PK_mnuNo], ([PK_mnuNo] + ' - ' + [mnuName]) As [mnuName] FROM [sysMenuBase]"
	...
	if loginUser ="" Then loginUser = "Admin"
		...
		If Not Page.IsPostBack Then
		 ...
		 If DB.sysMenu.DAT.sysMenuBZ.Request("mod")<>"2" Then '只能授權自已所擁有的 '97.12.16 nickey
		   ...
		   'get_MenuBase() '僅列示自已所擁有的單元
	       Dim DT as System.Data.DataTable=DB.sysMenu.DAT.sysMenuDT.GetMenuDT(-1,-1,Nothing,False,False,-100)
	       for i as integer=0 to DT.Rows.Count-1
	        list_members.Items.Add(New ListItem(DT.Rows(i)("PK_mnuNo") & " - " & DT.Rows(i)("mnuName"),DT.Rows(i)("PK_mnuNo")))
	       Next
		  ...
		  mNum = list_members.Items.Count
			...
			Call get_MenuBase() '列示所有的單元
			Call BindList() '列示所有的群組
		 End if
		 '----------------------
		...
		<table style="margin-left: 15; margin-top: 15" cellspacing="0" cellpadding="0" border="0">
			...
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<tr>
						<td><asp:TextBox onfocus="this.select();" id="text_grpName" runat="server" Width="200px" ReadOnly="True"></asp:TextBox></td>
					</tr>
					<tr>
