<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCGroup.ascx.vb" Inherits="UI.ActPayeeRpt.Web.UCGroup" %>
<table style="border-collapse: collapse; BORDER-RIGHT: #666668 1pt solid; BORDER-TOP: #666668 1pt solid; BORDER-LEFT: #666668 1pt solid; BORDER-BOTTOM: #666668 1pt solid"  border="0"  cellpadding="0" cellspacing="0">
	<tr style="display:block">
		<td colspan="4" style="text-align: center; padding-left:30px"><asp:Label ID="LBTitle" runat="server" Text="群組欄位"></asp:Label><input id="TBSelectFiled" runat="server" type="hidden" /></td>
	</tr>
	<tr>
