<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UI.PlanApprovalRPTItem.Web.FrmPlanApprovalRPTItem.Default" %>
...
<body>
    ...
    <div>
            <asp:Panel ID="pnlSearch" runat="server" class="MainCon3">
                <h1 class="h1Class">出國計畫執行情形維護</h1>
                  <table style="width: 100%">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td class="qury_table_td">填寫狀況</td>
                        <td class="qury_table_td3">
                            <asp:DropDownList ID="ddltrlAppRPTStatus" runat="server">
                                <asp:ListItem Value="" >...</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
            ...
            <div class="MainCon2">
                <h1 class="h1Class">出國計畫執行情形資料</h1>
                     ...
                     <asp:GridView ID="GridView1" runat="server" MyName="gvList" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="年度" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lblacmYear" runat="server" Text='<%# Eval("actPlanApprovalModel_B.acmYear") %>'></asp:Label>
                                    <asp:HiddenField ID="hdfacmYear" runat="server" Value='<%# Eval("actPlanApprovalModel_B.acmYear") %>'></asp:HiddenField>
                                    <asp:HiddenField ID="hdfplnTrlAppCode" runat="server" Value='<%# Eval("actPlanApprovalModel_B.plnTrlAppCode") %>'></asp:HiddenField>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" Width="38" />
                                <ItemStyle HorizontalAlign="Center" Width="38" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="出國計畫號" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lblplnTrlAppCode" runat="server" Text='<%# Eval("actPlanApprovalModel_B.plnTrlAppCode") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="實際出國計畫名稱" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lblplnTrlAppName" runat="server" Text='<%# Eval("actPlanApprovalModel_B.plnTrlAppName") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="國家" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lblappTrlCountry" runat="server" Text='<%# Eval("actPlanApprovalModel_B.appTrlCountry") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="城市" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lblappTrlCity" runat="server" Text='<%# Eval("actPlanApprovalModel_B.appTrlCity")  %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" Width="59" />
                                <ItemStyle HorizontalAlign="Center" Width="59" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="填寫狀況" Visible="True">
                                <ItemTemplate>
                                    <asp:Label ID="lbltrlAppRPTStatus" runat="server" Text='<%# Eval("trlAppRPTStatus")  %>'></asp:Label>
                                </ItemTemplate>
