<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmPassData.aspx.vb" Inherits="UI.Comm.Web.FrmPassData" %>

<%@ Register src="~/AppCtrls/CtrlsPay/UCPayPass.ascx" tagname="UCPayPass" tagprefix="uc1" %>
