...
<script language="javascript" type="text/javascript">
    ...
    function fnCallAcvBgtSourCntDialog(thisName, parParams) {
        var strReturnVal = showModalDialog("FrmAcvBgtSourCntEdit.aspx?" + parParams, window, "dialogWidth:640px;dialogHeight:480px; dialogTop: px; dialogLeft: px; edge: Raised; center: Yes; help: No; resizable: Yes; status: Yes;");
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                   ...
                                                                   <%-- <td style="padding-right: 5px" nowrap><asp:CheckBox ID="CBAutoTempPay" runat="server" Font-Size="X-Small" TextAlign="Right" Text="逕行暫付" Visible="True" onclick="ShowTmpPayData(this);chkTmpPayAndCash();" Enabled="False" /></td>--%>
                                                                    <td style="padding-right: 5px" nowrap><asp:CheckBox ID="CBAutoTempPay" runat="server" Font-Size="X-Small" TextAlign="Right" Text="逕行預付" Visible="True" onclick="ShowTmpPayData(this);chkTmpPayAndCash();" Enabled="False" /></td>
