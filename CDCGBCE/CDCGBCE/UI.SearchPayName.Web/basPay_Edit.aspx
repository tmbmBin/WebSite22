...
'====================================================================================================
	...
	Sub Page_Load(Sender As Object, E As EventArgs)
		...
		strMod = DB.sysMenu.DAT.sysMenuBZ.Request("mod")
		If strMod <> Nothing Then
			Select Case LCase(Trim(strMod))
				Case "edit"
					Editable = True
				...
				<asp:DataGrid id="dg_basPayName" runat="server" CellPadding="0" BorderStyle="Solid" style="TABLE-LAYOUT: fixed" AutoGenerateColumns="False" BackColor="#C1D1A1" ForeColor="Black" DataKeyField="payCode" OnItemCreated="dg_basPayName_ItemCreated" OnItemDataBound="dg_basPayName_ItemDataBound" OnSelectedIndexChanged="dg_basPayName_Select" AllowPaging="True" PageSize="3" OnPageIndexChanged="dg_basPayName_PageIndexChanged" OnPreRender="dg_basPayName_PreRender" ShowFooter="True">
					...
					<Columns>
						...
						<asp:TemplateColumn HeaderText="代碼">
							...
							<ItemTemplate>
								<asp:TextBox id="text_payCode" runat="server" style="TEXT-ALIGN: center; margin-top: -1" MaxLength="12" Width="35px" Text='<%# DataBinder.Eval(Container, "DataItem.payCode") %>' tooltip='<%# DataBinder.Eval(Container, "DataItem.payCode") %>' class="removeBorder" onfocus="this.className='applyBorder';this.select();" onblur="this.className='removeBorder'" ReadOnly='<%# Not(Editable) %>'></asp:TextBox>
							</ItemTemplate>
						</asp:TemplateColumn>
