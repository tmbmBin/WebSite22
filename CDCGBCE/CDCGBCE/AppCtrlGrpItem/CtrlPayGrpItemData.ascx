<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="CtrlPayGrpItemData.ascx.vb" Inherits="AppCtrlGrpItem.CtrlPayGrpItemData" %>
<%@ Import Namespace="Microsoft.Security.Application" %>

<table _ondblclick="alert('41:CtrlPayGrpItemData.ascx')" cellpadding="0" style="border-collapse: collapse; margin-top: -1; width: 100%" border="0">
	<tr>
		<td>
		<!-- ↓折疊項目(41) -->
		<table cellpadding="0" style="border-collapse: collapse; width: 100%" border="1" bordercolor="#FFFFFF">
			<tr>
				...
				<table cellpadding="0" style="border-collapse: collapse" border="0">
					<tr>
						<td width="1%" align="right"><img id="img_FoldTitle_41" border="0" src="images/minus.gif" onclick="show_item('FoldTitle_41', this.id)" align="top" style="margin-left: 0px; cursor: hand" alt="Collapse/Expand" /></td>
						<td width="99%" class="sFoldTitleFont" onclick="show_item('FoldTitle_41')">附記事項<font color="red" size="2pt">←請展開</font></td>
					</tr>
				</table>
				</td>
			</tr>
			<tr id="FoldTitle_41" style="display: block" onpropertychange="sync_title_img(this)">
														...
														<td>
															<asp:DataList ID="DataList2" runat="server" width="480" OnItemCreated="DataList2_ItemCreated" OnItemDataBound="DataList2_ItemDataBound" RepeatDirection="Horizontal" RepeatColumns="3" RepeatLayout="Flow">
																...
																<ItemTemplate>
                                                                    ...
                                                                    <%--20150602 [mdf]:修正UC載入錯誤--%>
                                                                    <asp:Literal id="Literal1" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.atdNameHtml") & "" %>'></asp:Literal>
																</ItemTemplate>
															</asp:DataList>
														</td>
													</tr>
				...
				<table cellpadding="3" style="border-collapse: collapse; margin-bottom: -2px; width: 100%" border="0" style="display:block">
					<tr>
						<td>
