<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmActMain1AssSearch.aspx.vb" Inherits="UI.CDCFun7.Web.FrmActMain1AssSearch" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" >
        function fnCallEditDialog(parParams) {

            var strReturnVal = showModalDialog("FrmActMain1Ass.aspx?" + parParams, window, "dialogWidth:820px;dialogHeight:480px; dialogTop: px; dialogLeft: px; edge: Raised; center: Yes; help: No; resizable: Yes; status: Yes;");
    ...
    <table style="margin-top: 10px; margin-left: 10px; border-collapse: collapse" cellpadding="5"
        ...
        <tr>
            <td bgcolor="#ffffff" height="10">
                <input id="ctl_OrderSql" type="hidden" runat="server" />
            </td>
        </tr>
        <tr>
            <td style="border-right: #666668 1pt solid; border-top: #666668 1pt solid; border-left: #666668 1pt solid;
                            ...
                            <asp:DataGrid ID="DG_actMain1" runat="server" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="動支編號" SortExpression="acmNo">
                                        <ItemTemplate>
                                            <asp:Label ID="ctl_AcmWordNum" runat="server" Text='<%#   DataBinder.Eval(Container, "DataItem.acmWordNum") & ""  %>'  ToolTip='<%# AntiXss.HtmlEncode(MyTools.NumTool.FormatNumberVal(Val(DataBinder.Eval(Container, "DataItem.acmNo") & "" ))) %>'
