<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmSentBoxList.aspx.vb" Inherits="UI.EMail.Web.FrmSentBoxList" %>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    GridLines="Both" Font-Size="Small" PageSize="20" AllowPaging="True">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="序號">
                                                        ...
                                                        <ItemTemplate>
                                                            <input id="ctl_mailSentNo" runat="server" type="hidden" value='<%# Eval("寄件備份流水號") %>' />
                                                    ...
                                                    <asp:TemplateField HeaderText="主旨">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="LBdgMailSubject" NavigateUrl='<%# "FrmEMail.aspx?TableName=mmsSentBox&MailSentNo=" & Eval("寄件備份流水號") %>' runat="server" Text='<%# Eval("郵件主旨") %>' Target="_blank" ></asp:HyperLink>                                                            
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="寄件日期">
                                                        <ItemTemplate>
                                                            <asp:Label ID="LBdgMailModifyDTime" runat="server" Text='<%# Eval("寄送時間") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>                                               
                                                    <asp:TemplateField HeaderText="寄信動作">
                                                        <ItemTemplate>
                                                            <input id="LBSendMail" type="button" runat="server" value="重新寄信"  onclick='<%# "if(confirm(" & chr(39) &"是否要重新寄送本封郵件?" & chr(39) &")) return OpenReSendMailPage("& Eval("寄件備份流水號") &"); else return false;" %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
