                        ...
                        <table cellpadding="0" style="border-collapse: collapse" border="0">
                            <tr>
                                ...
                                <td width="99%" class="sFoldTitleFont" onclick="show_item('FoldTitle_20')">
                                    出差內容<font color="red" size="2pt">←請展開</font>　<span style="font-size:13px; font-weight:bold; color:red">【請注意：美金匯率只適用於生活費的換算，生活費請輸入美金，其餘請輸入台幣。】</span>
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="padding: 5px">
                        <table cellpadding="5" cellspacing="0" style="table-layout: fixed" border="0">
                            <tr>
                                ...
                                <td style="text-align:left; font-size:12px; font-weight:bold; color:red; width:100px"></td>
                                <td width="100" align="right">
                                    美金匯率：</td>
                                <td width="100" align="right">
                                    <asp:TextBox ID="ctl_aceMoney" runat="server" Width="80px"
                                     onfocus="this.value=replaceString(this.value,',','');this.select()" Style="text-align: Right"
                                                onkeypress="javascript:MoneyOnly();" onblur="GetTotalTrlColMoney('UCActPayTrlDtl1_GV_actPayDtlTrl_ctl02_ctl_AcdTrlTAir');ReDoRowMoneyTotal('UCActPayTrlDtl1_GV_actPayDtlTrl_ctl02_ctl_AcdTrlTAir');if(this.value != ''){this.value=fmtMoney(this.value);};"
                                    ></asp:TextBox>
                                </td>
                                <td width="100" align="right">
                                    合計：</td>
                        ...
                        <div id="div_UCActPayVisa" class="DIV1_width" alt="DIV1">
                            ...
                            <asp:GridView ID="GV_actPayDtlTrl" runat="server" BackColor="White" BorderColor="#999999"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="飛機">
                                        <ItemTemplate>
                                            <asp:TextBox ID="ctl_AcdTrlTAir"  onfocus="this.value=replaceString(this.value,',','');this.select()" Style="text-align: Right"
                                                onkeypress="javascript:MoneyOnly();" onblur="if(this.value != ''){this.value=fmtMoney(this.value);};GetTotalTrlRowMoney(this.id,'ctl_AcdTrlTAir');GetTotalTrlColMoney(this.id);"
                                                MaxLength="8"
                                                runat="server" 
                                    ...
                                    <asp:TemplateField HeaderText="船舶">
                                        <ItemTemplate>
                                            <asp:TextBox ID="ctl_AcdTrlTBoats" onfocus="this.value=replaceString(this.value,',','');this.select()" Style="text-align: Right"
                                                onkeypress="javascript:MoneyOnly();" onblur="if(this.value != ''){this.value=fmtMoney(this.value);};GetTotalTrlRowMoney(this.id,'ctl_AcdTrlTBoats');GetTotalTrlColMoney(this.id);"
                                                 MaxLength="8"
                                                runat="server"  
                                    ...
                                    <asp:TemplateField HeaderText="長途陸運">
                                        <ItemTemplate>
                                            <asp:TextBox ID="ctl_AcdTrlTRail"  onfocus="this.value=replaceString(this.value,',','');this.select()" Style="text-align: Right"
                                                onkeypress="javascript:MoneyOnly();" onblur="if(this.value != ''){this.value= fmtMoney(this.value);};GetTotalTrlRowMoney(this.id,'ctl_AcdTrlTRail');GetTotalTrlColMoney(this.id);"
                                                  MaxLength="8"
                                                runat="server" 
                                    ...
                                    <asp:TemplateField HeaderText="生活費(US$)">
                                        <ItemTemplate>
                                            <asp:TextBox ID="ctl_AcdTrlAllowanceCrnMoney"  onfocus="this.value=replaceString(this.value,',','');this.select()" Style="text-align: Right"
                                                onkeypress="javascript:MoneyOnly();" onblur="if(this.value != ''){this.value=fmtMoney(this.value);};GetTotalTrlRowMoney(this.id,'ctl_AcdTrlAllowanceCrnMoney');GetTotalTrlColMoney(this.id);"
                                                 MaxLength="8"
                                                runat="server"  
                                                Width="60px" Enabled="True" DBFieldName="acdTrlAllowanceCrnMoney"></asp:TextBox>
                                        </ItemTemplate>
                                        <HeaderStyle Width="60px" ForeColor="Red" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="手續費">
                                        <ItemTemplate>
                                            <asp:TextBox ID="ctl_AcdTrlFAgency"  onfocus="this.value=replaceString(this.value,',','');this.select()" Style="text-align: Right"
                                                onkeypress="javascript:MoneyOnly();" onblur="if(this.value != ''){this.value=fmtMoney(this.value);};GetTotalTrlRowMoney(this.id,'ctl_AcdTrlFAgency');GetTotalTrlColMoney(this.id);"
                                                 MaxLength="8"
                                                runat="server"  
                                    ...
                                    <asp:TemplateField HeaderText="保險費">
                                        <ItemTemplate>
                                            <asp:TextBox ID="ctl_AcdTrlFInsurance"  onfocus="this.value=replaceString(this.value,',','');this.select()" Style="text-align: Right"
                                                onkeypress="javascript:MoneyOnly();" onblur="if(this.value != ''){this.value=fmtMoney(this.value);};GetTotalTrlRowMoney(this.id,'ctl_AcdTrlFInsurance');GetTotalTrlColMoney(this.id);"
                                                 MaxLength="8"
                                                runat="server"  
                                    ...
                                    <asp:TemplateField HeaderText="行政費">
                                        <ItemTemplate>
                                            <asp:TextBox ID="ctl_AcdTrlFAssign"  onfocus="this.value=replaceString(this.value,',','');this.select()" Style="text-align: Right"
                                                onkeypress="javascript:MoneyOnly();" onblur="if(this.value != ''){this.value=fmtMoney(this.value);};GetTotalTrlRowMoney(this.id,'ctl_AcdTrlFAssign');GetTotalTrlColMoney(this.id);"
                                                 MaxLength="8"
                                                runat="server"  
                                    ...
                                    <asp:TemplateField HeaderText="禮品交際費">
                                        <ItemTemplate>
                                            <asp:TextBox ID="ctl_AcdTrlFEntertain"  onfocus="this.value=replaceString(this.value,',','');this.select()" Style="text-align: Right"
                                                onkeypress="javascript:MoneyOnly();" onblur="if(this.value != ''){this.value=fmtMoney(this.value);};GetTotalTrlRowMoney(this.id,'ctl_AcdTrlFEntertain');GetTotalTrlColMoney(this.id);"
                                                 MaxLength="8"
                                                runat="server"  
                                    ...
                                    <asp:TemplateField HeaderText="雜費">
                                        <ItemTemplate>
                                            <asp:TextBox ID="ctl_AcdTrlFOther"  onfocus="this.value=replaceString(this.value,',','');this.select()" Style="text-align: Right"
                                                onkeypress="javascript:MoneyOnly();" onblur="if(this.value != ''){this.value=fmtMoney(this.value);};GetTotalTrlRowMoney(this.id,'ctl_AcdTrlFOther');GetTotalTrlColMoney(this.id);"
                                                 MaxLength="8"
                                                runat="server"  
