<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UI.TrlPlanReports.Web.FrmTrlPlanReport01.Default" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Panel ID="pnlSearch" runat="server" class="MainCon3">
                <h1 class="h1Class">
                    <asp:Label ID="lblRptTitle" runat="server" Text="Label"></asp:Label>
                </h1>
                <table style="width: 100%;">
                    <tr>
                        <td class="qury_table_td">年度(民國)</td>
                        <td class="qury_table_td2">
                            <asp:DropDownList ID="ddlTrlYear" runat="server" Width="150px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
            ...
            <div style="text-align: center; margin: 10px;">
                <asp:Button ID="btnExport" runat="server" Text="列出報表" class="Btn02" OnClick="btnExport_Click" />
