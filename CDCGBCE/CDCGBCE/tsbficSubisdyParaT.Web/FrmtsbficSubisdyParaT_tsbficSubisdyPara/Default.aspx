    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Panel ID="pnlSearch" runat="server" class="MainCon3">
                <h1 class="h1Class">獎補助參數設定作業資料查詢</h1>
                <table style="width: 100%">
                    ...
                    <tr>
                        <td class="qury_table_td"><div style="color:red;">備註：</div></td>
                        <td class="qury_table_td3" colspan="3">
                            <div style="color:red;">若為『一.補助其他政府機關 (1)直轄市政府、(2)臺灣省各縣市政府、(3)福建省各縣市政府』、『三.公保及退撫』、『四.公費就養』、『五.社會保險負擔』、『九.獎助』之情形者，無需填寫參數資料。</div>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
...
<%--                <input type="button" id="btnView" value="檢視" class="Btn02" onclick="btnClick('View', '檢視資料')" />
            ...
            <div class="MainCon2">
                <h1 class="h1Class">獎補助參數設定作業資料明細</h1>
