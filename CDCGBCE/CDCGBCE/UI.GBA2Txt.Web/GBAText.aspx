...
<body>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="80%">
        ...
        <tr>
            ...
            <td class="style1">
                <asp:TextBox ID="txtLotNumber" runat="server" MaxLength="9"></asp:TextBox>
                <br />
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
                    ControlToValidate="txtLotNumber" Display="Dynamic" ErrorMessage="請輸入9位數之批號" 
                    ValidationExpression="([0-9]|[a-z]|[A-Z]){9}" ValidationGroup="Submit"></asp:RegularExpressionValidator>
            </td>
            <td align="center" class="style1">
                &nbsp;</td>
            <td class="style1">
