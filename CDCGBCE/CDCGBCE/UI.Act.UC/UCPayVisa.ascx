											...
											<tr>
												...
												<table style="margin-left: 0px" border="0" cellpadding="0" cellspacing="0">
													<tr>
														...
														<td style="BORDER-RIGHT: #ffffff 1px solid; WIDTH: 40px;display:none"><asp:CheckBox ID="CBdgPrePayFlag" runat="server" Enabled="false" /></td>
														<td style="WIDTH: 80px;display:none"><asp:CheckBox ID="CBdgInspect" runat="server" Enabled="true" /></td>
															...
															<ItemTemplate>
																<table style="MARGIN-left:0px" border=0 cellpadding=0 cellspacing=0>
																	 <tr>
																		...
																		<td style="BORDER-RIGHT: #ffffff 1px solid; WIDTH: 40px; background-color: #FFFFE0;display:none"><asp:CheckBox ID="CBdlPrePayFlag" runat="server" /></td>
																		<td style="BORDER-RIGHT: #ffffff 1px solid; WIDTH: 40px; background-color: #FFFFE0;display:none"><asp:CheckBox ID="CBdlInspect" runat="server" style="MARGIN-left: 0px" /></td>
