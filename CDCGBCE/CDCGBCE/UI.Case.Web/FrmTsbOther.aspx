...
<body topmargin="5" leftmargin="10" rightmargin="0" bottommargin="50" onload='get_cookies();showfiled();ShowAddVisaData();' onunload='set_cookies()' style="background-color: white">
                                                                ...
                                                                <td style="text-align: left">
                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr>
                                                                            ...
                                                                            <td style="padding-right: 5px" nowrap>
                                                                                <asp:CheckBox ID="CBSeparateFlag" runat="server" Font-Size="X-Small" TextAlign="Right" Text="分期付款" Visible="True" />
                                                                            </td>
                                                                            <td style="padding-right: 5px" nowrap>
                                                                ...
                                                                <td style="text-align: right">
                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr>
                                                                            ...
                                                                            <td style="padding-right: 5px" nowrap>&nbsp;</td>
                                                                            <td style="padding-right: 5px" nowrap>
                                                                                <asp:CheckBox ID="CBAutoTempPay" runat="server" Font-Size="X-Small" TextAlign="Right" Text="逕行暫付" Visible="True" Style="display: none" onclick="showfiled(this);chkTmpPayAndCash();" />
                                                                                <asp:CheckBox ID="CBAddVisa" runat="server" Font-Size="X-Small" TextAlign="Right" Text="加簽" Visible="True" Style="display: none" onclick="ShowAddVisaData(this);" /></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            </tr>
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="TBSearchSql" runat="server" Style="text-align: center; width: 90px" onkeypress="if(event.keyCode==13) {this.blur();return false;} else return check_Num()" onblur="if(this.value==''){this.value='尋找動支編號';}" onfocus="this.select()" onclick="this.value=''" AutoPostBack="True">尋找動支編號</asp:TextBox>
                                                        <input type="button" style="height: 22px; width: 16px; font-family: Webdings; font-size: 8pt" value="s"></td>
                                                    <td>
