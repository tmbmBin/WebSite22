                                                                ...
                                                                <td style="text-align: left">
                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr>
                                                                            ...
                                                                            <td style="padding-right: 5px" nowrap>
                                                                                <asp:CheckBox ID="CBDocFlag" runat="server" Font-Size="X-Small" TextAlign="Right" Text="簽文" Visible="True" />
                                                                            </td>
                                                                            <td></td>
                                                                        </tr>
                                                                    </table>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="padding-right: 5px" nowrap>
                                                                               ...
                                                                               <%-- <asp:CheckBox ID="CBAutoTempPay" runat="server" Font-Size="X-Small" TextAlign="Right" Text="逕行暫付" Visible="True" onclick="showfiled(this);chkTmpPayAndCash();" />--%>
                                                                                <asp:CheckBox ID="CBAutoTempPay" runat="server" Font-Size="X-Small" TextAlign="Right" Text="逕行預付" Visible="True" onclick="showfiled(this);chkTmpPayAndCash();" />
