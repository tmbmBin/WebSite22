<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCPayDtlProd.ascx.vb" Inherits="AppCtrls.UCPayDtlProd" %>
...
<table _ondblclick="alert('21:UCPayDtlProd.ascx')" cellpadding="0" style="border-collapse: collapse; margin-top: -1; width: 100%" border="0">
	<tr>
		<td>
		<!-- ↓折疊項目(21) -->
		<table cellpadding="0" style="border-collapse: collapse; width: 100%" border="1" bordercolor="#FFFFFF">
			<tr>
				...
				<table cellpadding="0" style="border-collapse: collapse" border="0">
					<tr>
						<td width="1%" align="right"><img id="img_FoldTitle_21" border="0" src="images/minus.gif" onclick="show_item('FoldTitle_21', this.id)" align="top" style="margin-left: 0px; cursor: hand" alt="Collapse/Expand" /></td>
						<td width="99%" class="sFoldTitleFont" onclick="show_item('FoldTitle_21')">請購項目<font color="red" size="2pt">←請展開</font></td>
					</tr>
				</table>
				</td>
			</tr>
			<tr id="FoldTitle_21" style="display: block" onpropertychange="sync_title_img(this)">
				...
				<table cellpadding="5" cellspacing="0" style="TABLE-LAYOUT: fixed" border="0">
					...
					<tr>
						<td width="100" align="right"><img id="img21" border="0" src="images/plus.gif" onclick="scale_item(this.id)" align="top" style="margin-left: -5px; cursor: hand" alt="Collapse/Expand" /><span style="cursor: hand" onclick='img21.fireEvent("onclick")'>請購項目</span></td>
				...
				<table cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td>
						<div id="div_UCPayDtlProd" class="DIV2_width" alt="DIV2">
							<asp:datagrid id="DataGrid2" runat="server" AutoGenerateColumns="False">
								<HeaderStyle Font-Size="X-Small" Wrap="False" HorizontalAlign="Center" ForeColor="#F7F7F7" BackColor="#4A3C8C"></HeaderStyle>
								...
								<Columns>
									<asp:TemplateColumn>
										...
										<ItemTemplate>
											<asp:Label id="LBdgNo" runat="server" Width="15px"><%# Container.ItemIndex +1 %></asp:Label>
									...
									<asp:TemplateColumn HeaderText="用　　　　　　途">
										<HeaderStyle Font-Size="X-Small" HorizontalAlign="Center" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Wrap="False"></HeaderStyle>
										<ItemStyle Font-Size="X-Small"></ItemStyle>
										<ItemTemplate>
									...
									<asp:TemplateColumn HeaderText="廠商1" Visible="true">
										...
										<HeaderTemplate>
											<table border=0 width=100% cellpadding=1 cellspacing=0 height=100% style="table-layout:fixed; margin-left:-20; margin-right:-10; margin-top:-3; margin-bottom:-3" >
												...
												<tr  style="display:none">
												    <td  valign=top  colspan=2  style="color:#ffffff;BORDER-Bottom: #ffffff 1px solid;Text-align:Center"><font size="2" color="white">總價</font>  <asp:TextBox ID="TBdgProdMoney1" runat="server" Width=100  MyName="TBdgProdMoney2"  Enabled =false  style="background-color:#ffffe0; text-align:right" onfocus="this.blur()"></asp:TextBox></td>
											    </tr>
												<tr>
									...
									<asp:TemplateColumn HeaderText="廠商3" Visible="false" >
										...
										<HeaderTemplate>
											<table  border=0 width=100% cellpadding=1 cellspacing=0 height=100% style="table-layout:fixed; margin-left:-20; margin-right:-10; margin-top:-3; margin-bottom:-3" >
												...
												<tr  style="display:none">
												    <td  valign=top  colspan=2  style="color:#ffffff;BORDER-Bottom: #ffffff 1px solid;Text-align:Center"><font size="2" color="white">總價</font>  <asp:TextBox ID="TBdgProdMoney3" runat="server" Width=100  MyName="TBdgProdMoney2"  Enabled =false  style="background-color:#ffffe0; text-align:right" onfocus="this.blur()"></asp:TextBox></td>
											    </tr>
												<tr>
													<td valign=bottom align=center style="color:#ffffff;BORDER-Right: #ffffff 1px solid;Text-align:Center"><font size="2" color="white">單價</font></td>
													<td valign=bottom  align=center  style="color:#ffffff; Text-align:Center; padding-top:5px" ><font size="2" color="white">總價</font></td>
										...
										<ItemStyle Font-Size="X-Small" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False"></ItemStyle>
										<ItemTemplate>
											<asp:TextBox id="TBdgPrice3" style="TEXT-ALIGN: right; background-color: #FFFFE0"   runat="server" Width="70px" onFocus="this.select();" onkeypress="return check_Num()" onblur="GetRowTotal(this);GetMinCol();" MyName="TBdgPrice3" MyIndex="<%# Container.ItemIndex  %>"  MyColIndex="3" ></asp:TextBox>
											<asp:TextBox id="TBdgMoney3" style="TEXT-ALIGN: right; background-color: #FFFFE0"   runat="server" Width="70px"  onFocus="this.select();" onkeypress="return check_Num()" MyName="TBdgMoney3" MyIndex="<%# Container.ItemIndex  %>" MyColIndex="3"  ></asp:TextBox>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderText="移除">
										<HeaderStyle Wrap="False" Width="30px"  forecolor="DarkOrange" Font-Size=X-Small ></HeaderStyle>
										...
										<ItemTemplate>
											<input id="CBdgDel" type="checkbox"  runat="server" ToolTip="移除勾選的資料列"   MyName="CBdgDel" MyIndex="<%# Container.ItemIndex %>" onclick="GetMinCol(this);" disabled="disabled" />
										</ItemTemplate>
