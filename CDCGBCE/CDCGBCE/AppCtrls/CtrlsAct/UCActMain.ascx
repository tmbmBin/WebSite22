							...
							<table cellpadding="0" style="border-collapse: collapse; margin-top: -1; width: 100%; display:none" border="1" bordercolor="#FFFFFF">
								<tr>
									...
									<table cellpadding="5" cellspacing="0" style="TABLE-LAYOUT: fixed" border="0">
										<tr>
											<td width="100" style="text-align:right"  style="color: #FF0000">核支日期</td>
											...
											<td width="100">　</td>
											<td width="100" style="text-align:right" style="color: #FF0000"><span style="<%=strShowByPassFlag%>">核支金額</span></td>
										...
										<tr>
											<td width="100" style="text-align:right" style="color: #FF0000">核退原因</td>
        ...
        <td style="padding: 0px">
            <table cellspacing="0" style="table-layout: fixed; border-collapse: collapse; width: 100%; padding: 2px;" border="0">
                ...
                <tr>
                    ...
                    <td style="width: 80px; text-align: right" id="TDAddVisaData1">原簽單號</td>
                    <td style="width: 100px; text-align: left" id="TDAddVisaData2">
                ...
                <tr style="<%= strShowPayNameFlag %>">
                    ...
                    <td colspan="5">
                        <asp:TextBox ID="TBPayName" runat="server" Width="440px" MaxLength="100" Enabled="False"></asp:TextBox></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
