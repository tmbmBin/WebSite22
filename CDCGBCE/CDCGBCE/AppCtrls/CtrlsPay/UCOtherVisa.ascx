...
<!--
    ...
    function fnCallRptDtl(parObj) {
        ...
        strPars = "acmyear=" + tmpArray[0] + "&acmno=" + tmpArray[1] + "&acvno=" + tmpArray[2] + "&acmno1=" + tmpArray[3] + "&acvno1=" + tmpArray[4] +
                  "&acmno2=" + tmpArray[5] + "&acvno2=" + tmpArray[6] + "&acppayyear=" + tmpArray[7] + "&acppayno=" & tmpArray[8] +
                  "&acvsubno=" + tmpArray[9] + "&acmmemo=" + escape(tmpMemo);
    ...
    function GetTotalPassAcvMoney(parObj) {
        ...
        if (strKid.toLowerCase() == "prodex" || strKid.toLowerCase() == "trlos" || strKid.toLowerCase() == "tother" || strKid.toLowerCase() == "otherext") {
                                        ...
                                        <asp:DataGrid ID="DataGrid2" runat="server" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="年度">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="TBdgAcvBgtYear" runat="server" Width="100%" Style="text-align: Center">195</asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="月份">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="TBdgAcvBgtMonth" runat="server" Width="100%" Style="text-align: Center" MyName="TBdbMonth" MyIndex='<%# Container.ItemIndex %>'>12</asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="門別">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="DDLdgKind" runat="server" Width="100%" Style="background-color: #ffffe0" MyName="DDLdgKind" MyIndex='<%# Container.ItemIndex %>' OnChange="setShowBudget(this)">
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="預算來源">
                                                    ...
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></ItemStyle>
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="DDLdgBgtSource" runat="server" Width="80px" Style="background-color: #FFFFE0" MyName="DDLdgbgtSource" MyIndex='<%# Container.ItemIndex %>' onChange="showAcvBgtSourCnt(this.id);"></asp:DropDownList>
                                                        <table id="TBAcvBgtSour" border="0" style="table-layout: fixed; border-collapse: collapse; font-size: 10px;">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="LBAcvBgtSourTitle" Style="display: none" runat="server" Text="次數："></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="TBAcvBgtSourCnt" Style="display: none" runat="server" Width="30px" MyName="TBAcvBgtSourCnt" MyIndex='<%# Container.ItemIndex %>'></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateColumn HeaderText="經費單位">
                                                    <HeaderStyle Width="160px" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="X-Small" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False"></HeaderStyle>
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></ItemStyle>
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="DDLdgBgtDepCode" runat="server" Width="100%" Style="background-color: #FFFFE0" MyName="DDLdgBgtDepCode" MyIndex='<%# Container.ItemIndex %>' AutoPostBack="true">
                                                            <asp:ListItem Value=""></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="控帳業務">
                                                    <HeaderStyle Width="130px" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="X-Small" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False"></HeaderStyle>
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></ItemStyle>
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="DDLdgBiz" runat="server" Width="100%" Style="background-color: #FFFFE0" MyName="DDLdgBiz" MyIndex='<%# Container.ItemIndex %>' AutoPostBack="True">
                                                            <asp:ListItem Value=""></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                ...
                                                <asp:TemplateColumn HeaderText="計畫科目">
                                                    <HeaderStyle Width="250px" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="X-Small" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False"></HeaderStyle>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="DDLdgPlan" runat="server" Style="background-color: #FFFFE0" Width="100%" AutoPostBack="False" MyName="DDLdgPlan" MyIndex='<%# Container.ItemIndex %>' CssClass='<%# Container.ItemIndex %>' EnableViewState="True" onmousedown="tranSeleGroup(this,'*');autowidth(this);" onblur="defwith(this);"></asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="用途別科目">
                                                    ...
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></ItemStyle>
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="DDLdgOul" Style="background-color: #ffffe0;" runat="server" Width="100%" MyName="DDLdgOul" MyIndex='<%# Container.ItemIndex %>' onmousedown="autowidth(this);" onblur="defwith(this);" EnableViewState="true"></asp:DropDownList>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                <asp:TemplateColumn HeaderText="動支金額">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="TBdgMoney" runat="server" Width="100%" Style="text-align: right; background-color: #FFFFE0" onFocus="this.select()" onkeypress="return check_Num()" MyName="TBdgMoney" MyIndex='<%# Container.ItemIndex %>' onblur="GetTotalAcvMoney(this);"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
                                                ...
                                                <asp:TemplateColumn HeaderText="就地審計">
                                                    <HeaderStyle Width="30px" Font-Size="XX-Small" HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
                                                ...
                                                <asp:TemplateColumn HeaderText="移除">
                                                    <HeaderStyle Width="30px" Wrap="False" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></HeaderStyle>
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                                                    <ItemTemplate>
