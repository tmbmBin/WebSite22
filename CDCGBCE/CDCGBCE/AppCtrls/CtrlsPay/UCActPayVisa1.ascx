<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCActPayVisa1.ascx.vb" Inherits="AppCtrls.UCActPayVisa1" %>
...
<TABLE cellSpacing="1" cellPadding="1" width="600" border="0">
                ...
                <td>
                        <table border=0 cellspacing=0   width =100% style="table-layout:fixed">
                                <tr>
                                        ...
                                        <td   Width="150px"  ><asp:DropDownList ID="DDLBgtDep" runat="server" Width="150px" AutoPostBack="True" Enabled="False"></asp:DropDownList></td>
                                </tr>
                        </table>
                </td>
        </tr>
        <tr>
                ...
                <DIV id=MyDiv  style="BORDER-RIGHT: 1px groove; BORDER-TOP: 1px groove; BEHAVIOR: url(<%= resolveurl(scrollposurl)%>); OVERFLOW: auto; BORDER-LEFT: 1px groove; WIDTH: 600px; BORDER-BOTTOM: 1px groove; HEIGHT: 150px"    scrollpos="<%= savescrollpos.value %>"   persistid="<%= savescrollpos.uniqueid %>">
                <input id="savescrollpos" type="hidden" name="savescrollpos" runat="server">
													<asp:datagrid id="DataGrid2" runat="server" Width="1350px" AutoGenerateColumns="False">
														...
														<Columns>
															...
															<HeaderStyle Width="120px" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="Small" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" ></HeaderStyle>
																<ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></ItemStyle>
																<ItemTemplate>
																	<asp:DropDownList id="DDLdgBgtSource" runat="server" Width="120" Style="background-color: #FFFFE0" MyName="DDLdgbgtSource" MyIndex='<%# Container.ItemIndex %>' >
																	</asp:DropDownList>
																</ItemTemplate>
															</asp:TemplateColumn>
															...
															<asp:TemplateColumn HeaderText="用途別科目">
																...
																<ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Width="200px" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></ItemStyle>
																<ItemTemplate>
																<asp:DropDownList id="DDLdgOul" style="BACKGROUND-COLOR: #ffffe0" runat="server" Width="200" MyName="DDLdgOul" MyIndex='<%# Container.ItemIndex %>'></asp:DropDownList> 																 
																</ItemTemplate>																
															</asp:TemplateColumn>
                                                            <asp:TemplateColumn HeaderText="動支金額">
                                                            <HeaderStyle Width="160px" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="Small" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" ></HeaderStyle>
                                                            ...
                                                            <asp:TemplateColumn HeaderText="暫付">
																...
																<ItemTemplate><asp:CheckBox id="CBdgPrePay" runat="server"  >
																							</asp:CheckBox></ItemTemplate>
                                                                <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                                    Font-Underline="False" Wrap="False" />
                                                            </asp:TemplateColumn>
                                                            <asp:TemplateColumn HeaderText="GBA">
                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
																<ItemTemplate>
																    <asp:button id="BtnGBA" runat="server" Text="GBA" Width="30px" Height="20px" CssClass='<%# Container.ItemIndex %>' OnClick="BtnGBA_Click" ></asp:button>
															    </ItemTemplate>
                                                                <HeaderStyle  Wrap="False" />
															</asp:TemplateColumn>
															<asp:TemplateColumn HeaderText="明細資料">
                                                            	<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
																<ItemTemplate>
																    <input id="BtnRptDtl" runat="server" type="button"  value="..." onclick="fnCallRptDtl(this)" style="height:22px" />
																	<asp:CheckBox id="CBdgInspect" runat="server"  Visible=false  ></asp:CheckBox>
															    </ItemTemplate>
                                                                <HeaderStyle  Wrap="False" />
															</asp:TemplateColumn>
       ...
       <tr>
               <td>
                   <asp:Button ID="BtnAddRow" runat="server" Text="增加列數" Enabled="False" /></td>
       </tr> 
</table>