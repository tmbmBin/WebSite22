<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UCWhere803.ascx.vb" Inherits="AppCtrlSearch.UCWhere803" %>
<style type="text/css">
	.TxtStyle
	{
		width: 100px;
...
<table id="TableCtrl" style="table-layout:fixed" runat="server" cellpadding="1" cellspacing="1" border="0" width="500px">
	...
	<tr>
		<td class="TxtStyle">計畫名稱：</td>
		<td colspan="3"><asp:DropDownList ID="DDLPlanNamePN" runat="server" Width="390px"></asp:DropDownList></td>
	</tr>
	<tr>
		<td class="TxtStyle">計畫科目：</td>
		<td colspan="3"><asp:DropDownList ID="DDLOulNamePN" runat="server" Width="390px"></asp:DropDownList></td>
	</tr>
	<tr>
