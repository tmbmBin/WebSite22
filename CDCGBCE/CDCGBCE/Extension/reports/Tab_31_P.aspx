...
<script runat="server">
	...
	Function get_AllData(acpPayYear As String, acpPayMonth As String, WorkUnitNo As String, WorkUnitSubNo As String, WorkUserNo As String, Optional Bat As String = Nothing, Optional Prev As String = Nothing) As System.Data.DataSet
		...
		Dim selectString As String = "SELECT actMain.acmWorkUnitNo, codDepartName.dptName AS acmWorkUnitName, " & _
								...
								"actPayVisa.acvOutlayYear AS acvPlanYear, actPayVisa.acvPlanCode, " & _
									 "codPlanCode.plnPlanName AS acvPlanName, actPayVisa.acvOutlayYear, " & _
									 "actPayVisa.acvOutlayCode, codOutlayCode.oulOutlayName AS acvOutlayName, " & _
...
'		Response.End
	...
	Sub Page_Load(Sender As Object, E As EventArgs)
		...
		Dim newDS As New System.Data.DataSet
			...
			newDS.Tables(0).Columns.Add("PageGroup", Type.GetType("System.Int32"))
			newDS.Tables(0).Columns.Add("ODBY", Type.GetType("System.String"))
				...
				Else
					...
					If tmpDS.Tables(0).Rows(i).Item("acvPlanCode") <> acvPlanCode Then
						...
						NR = newDS.Tables(0).NewRow()
							...
							NR("acvPlanName") = tmpDS.Tables(0).Rows(i-1).Item("acvOutlayNamePrev")
NR("acvOutlayName") = NR("acvPlanName")
...
Dim pGroup As Integer = -1
For i As Integer = newDS.Tables(0).Rows.Count() - 1 To 1 Step -1
	If newDS.Tables(0).Rows(i-1)("PageFlag") = "0" Then
		newDS.Tables(0).Rows(i)("PageTitle") = newDS.Tables(0).Rows(i-1)("PageTitle")
		newDS.Tables(0).Rows(i)("PagePlanNoName") = newDS.Tables(0).Rows(i-1)("PagePlanNoName")
		newDS.Tables(0).Rows(i)("PageOutlayName") = newDS.Tables(0).Rows(i-1)("PageOutlayName")
		newDS.Tables(0).Rows(i)("PageGroup") = pGroup
		newDS.Tables(0).Rows.RemoveAt(i-1)
		pGroup -= 1
	Else
		If newDS.Tables(0).Rows(i)("PageGroup") & "" = "" Then newDS.Tables(0).Rows(i)("PageGroup") = pGroup
	End If
Next i
For i As Integer = 0 To newDS.Tables(0).Rows.Count() - 1
	newDS.Tables(0).Rows(i)("ODBY") = "A" & Right("00000000" & i, 8)
Next i
'		DataGrid1.DataSource = newDS
'		DataGrid1.DataBind()
