<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmOTPay.aspx.vb" Inherits="UI.OTPay.Web.FrmOTPay" %>
...
<link type="text/css" rel="stylesheet"  href="/CSSFiles/FrmOTPay.css"/>

<script language="javascript" type="text/javascript" src="../ScriptFiles/ShowBgtWeb/ShowPayBudget.js"  ></script>
...
<script language="javascript" type="text/javascript" src="../ScriptFiles/TableSum.js"  ></script>
<script language="javascript" type="text/javascript" src="../ScriptFiles/TableTools.js"  ></script>
<script language="javascript" type="text/javascript" src="/ScriptFiles/FrmOTPay.js" ></script>
<script language="javascript" type="text/javascript" >
    ...
    function fnOpenOTData(parParams) {
        var strParams;
        strParams = "&sessionid=" + document.all("ctl_SessionID").value.toString();

        var strReturnVal = showModalDialog("FrmActPayeePay.aspx?type=2" + strParams  + parParams, window, "dialogWidth:640px;dialogHeight:480px; dialogTop: px; dialogLeft: px; edge: Raised; center: Yes; help: No; resizable: Yes; status: Yes;");
...
<body topmargin="5" leftmargin="10" rightmargin="0" bottommargin="50" onload='get_cookies();ShowTmpPayData();' onunload='set_cookies()'>
