				...
				<tr>
					...
					<table cellpadding="0" style="border-collapse: collapse" border="1" bordercolor="#666668" bgcolor="#DADEE9">
						<tr>
									...
									<table cellpadding="0" style="border-collapse: collapse; width:600px" border="0">
										<tr>
											...
											<table cellpadding="0" cellspacing="0" border="0">
												<tr>
													<td style="padding-right: 5px" nowrap><asp:CheckBox ID="CBAllowanceFalg" 
												...
												<tr>
													<td align="right" style="padding-left: 5px" nowrap>
                                                        <asp:CheckBox id="CBAcpUnitPassFlag" runat="server" Font-Size="X-Small" 
                                                            TextAlign="Left" Text="單位審核" Enabled="False" Visible="False" />　</td>
													<td align="right" style="padding-left: 5px" nowrap><asp:CheckBox id="CBSecrearyFlag" runat="server" Font-Size="X-Small" TextAlign="Left" Text="秘書室審核" Enabled="False" Visible="False" /></td>
								...
								<tr>
									...
									<table cellpadding="2" cellspacing="0" style="TABLE-LAYOUT: fixed" border="0">
										<tr>
											...
											<td width="100"><asp:TextBox id="TBAcpMarkDate" runat="server" style="text-align:center; background-color: #FFFFE0" Width="90px" ondblclick="JavaScript: UCDate.Show();" Enabled="False"></asp:TextBox></td>
											<td width="100" align="right">轉正金額</td>
											<td width="100"><asp:TextBox id="TBAcpMoney" runat="server" MyName="TBPayMoney" style="text-align:right" BackColor="Transparent" Width="90px" onfocus="this.blur();" onkeypress="return check_Num()"></asp:TextBox></td>
											<td width="100" align="right">轉正次數</td>
											<td width="100"><asp:DropDownList id="DDLAcpPayNo1" runat="server" Width="90px" AutoPostBack="True"></asp:DropDownList></td>
										</tr>
										<tr>
											<td width="100" align="right">群組編號</td>
											<td width="100"><asp:TextBox ID="TBAcpGroupNo" runat="server" MaxLength="10" Width="90px" Enabled="False"></asp:TextBox></td>
							...
							<!-- ↓區塊(5) --><!-- 區塊(5)↑ -->
							<!-- Insert 區塊 here -->
							    <span id="TRTmpProdData" style="<%=strShowProdData %>"><asp:PlaceHolder ID="PlaceHolder3" runat="server"></asp:PlaceHolder></span>
							    <span id="TRTmpProdData1" style="<%=strShowProdData %>"> <asp:PlaceHolder ID="PlaceHolder7" runat="server"></asp:PlaceHolder></span>
						...
						<tr>
							...
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									...
									<td><input type="button" id="BtnPrint" runat="server" style="width: 50px; height: 22px" value="列印"   onclick="fnCallReportMenu();"  /></td>
									<td>&nbsp;</td>
									...
									<td><input type="hidden" id="TBPrintVal" runat="server" name="TBPrintVal" /></td>
								</tr>
							</table>
							</td>
						</tr>
									...
									<table cellpadding="0" style="border-collapse: collapse" border="0">
										<tr>
											...
											<td><asp:dropdownlist id="DDLSortPassFlag" runat="server" AutoPostBack="True">
													...
													<asp:ListItem Value="2">未轉正</asp:ListItem>
