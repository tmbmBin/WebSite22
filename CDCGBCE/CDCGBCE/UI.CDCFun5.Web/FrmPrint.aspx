<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmPrint.aspx.vb" Inherits="UI.CDCFun5.Web.FrmPrint" %>
							...
							<tr>
								<td>
									<table cellspacing="0" cellpadding="1" width="100%" border="0">
										<tr>
										    <td>
										        <table style="table-layout:fixed; border-collapse:collapse; width:100%; padding:1px" cellspacing="0" border="0">
										            <tr>
										                <td style="text-align:right; width:90px">日期區間：</td>
										                <td colspan="3">
										            ...
										            <tr>
										                <td style="text-align:right; width:90px">經費單位：</td>
										                <td width="120px">
                                                            <asp:DropDownList ID="DDLBgtDepName" runat="server">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td style="text-align:right; width:90px">動支編號：</td>
										                <td >
										            ...
										            <tr>
                                                        ...
                                                        <td  align="right" width="90">承辦人名：</td>
                                                        <td>
										            ...
										            <tr align="right" width="90">
                                                        <td align="right" width="90">審核狀態：</td>
										                <td  align="left" width="90"><asp:DropDownList ID="DDLPassFlag" runat="server" Width="120px">
