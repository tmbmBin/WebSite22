<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmEntrustData.aspx.vb" Inherits="UI.CDCFun5.Web.FrmEntrustData" %>
...
<script language="javascript" src="../ScriptFiles/JSStrFun.js" type="text/javascript"></script>
		<script language="javascript">
		    ...
		    function fnCallMemoDialog(thisName) {
		        ...
		        var strReturnVal = showModalDialog("FrmMemoPicker.aspx?rptflag=6&memokeys=" + document.getElementById("TBMemoKeys").value + "&", window, "dialogWidth:820px;dialogHeight:480px; dialogTop: px; dialogLeft: px; edge: Raised; center: Yes; help: No; resizable: Yes; status: Yes;");
        ...
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td><asp:button id="BtnAdd" runat="server" Text="新增" Width="50px" Height="22px" Visible="False"></asp:button></td>
                                    ...
                                    <table border="1" cellpadding="0" cellspacing="0"  style="border-collapse: collapse; border-style: solid; border-width: 1px" bordercolor=#999966>
	                                    ...
	                                    <tr style="display:none">
		                                    <td style="text-align:right"  colspan="19" >
                                                ...
                                                <asp:TextBox ID="TBPrjCaseNo" runat="server"></asp:TextBox></td>
	                                    </tr>
	                                    <tr>
