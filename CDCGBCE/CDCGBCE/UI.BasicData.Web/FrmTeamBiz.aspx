...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmTeamBiz.aspx.vb" Inherits="UI.BasicData.Web.FrmTeamBiz"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>FrmTeamBiz</title>
							...
							<tr>
								<td>
									<table id="table6" style="WIDTH: 500px; HEIGHT: 80px" cellSpacing="0" cellPadding="1" border="0">
										<tr>
											<td style="HEIGHT: 8px" align="right" width="89"><font style="FONT-SIZE: 11pt" face="新細明體">帳別名稱</font></td>
												...
												<table id="table17" cellSpacing="0" cellPadding="0" border="0">
													<tr>
														...
														<td style="BORDER-LEFT: #edecf2 1px solid" vAlign="bottom" align="center"><asp:textbox id="TBSearchSql" onfocus="this.select()" onclick='this.value=""' runat="server"
																AutoPostBack="True" Width="96px">輸入帳別代碼</asp:textbox></td>
