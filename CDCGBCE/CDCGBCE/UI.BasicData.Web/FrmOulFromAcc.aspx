<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmOulFromAcc.aspx.vb" Inherits="UI.BasicData.Web.FrmOulFromAcc" %>
                           ...
                           <tr>
                               <td>
                                    <table style="table-layout:fixed" border=0 cellpadding=0 cellspacing=0 width=100%>
                                        <tr>
                                            <td style="width:100px; text-align:right">用途別代碼 ：</td>
                                            <td style="width:150px"><asp:TextBox ID="TBOulCode" runat="server"></asp:TextBox></td>                    
                                            <td style="width:100px; text-align:right">用途別名稱：</td>
                                            <td style="width:150px"><asp:TextBox ID="TBOulName" runat="server"></asp:TextBox></td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                        <tr>
               ...
               <tr>
                   <td style="BORDER-RIGHT: #666668 1pt solid; BORDER-TOP: #666668 1pt solid; BORDER-LEFT: #666668 1pt solid; BORDER-BOTTOM: #666668 1pt solid" bordercolor="#666668">
                       <table style="TABLE-LAYOUT: fixed; BORDER-COLLAPSE: collapse" bordercolor="#ffffff" cellpadding="5" width="100%" border="1">
                             <tr>
                               <td>
                                    <asp:datagrid id="DataGrid1" runat="server" Width="100%" Height="72px" CellPadding="3" BorderColor="White" BorderWidth="1px" AutoGenerateColumns="False" BackColor="White" BorderStyle="None">
													...
													<Columns>
														...
														<asp:BoundColumn DataField="oulAliasNo" HeaderText="列印代碼"></asp:BoundColumn>
