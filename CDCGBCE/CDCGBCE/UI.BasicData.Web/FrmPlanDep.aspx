<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FrmPlanDep.aspx.vb" Inherits="UI.BasicData.Web.FrmPlanDep"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>FrmPlanDep</title>
										...
										<TABLE id="Table1" style="TABLE-LAYOUT: fixed" cellPadding="1" width="100%" border="0">
											<TR>
												...
												<TD vAlign="bottom" align="left">
													<asp:DropDownList id="DDLPlan" runat="server"></asp:DropDownList></TD>
											<TR>
												<TD vAlign="bottom" align="right" style="WIDTH: 127px">部門名稱</TD>
												<TD vAlign="bottom" align="left"><asp:DropDownList id="DDLDep" runat="server"></asp:DropDownList>
												</TD>
											</TR>
										</TABLE>
									</FONT>
								...
								<td>
									<asp:DataGrid id="DataGrid1" runat="server" AutoGenerateColumns="False" Width="100%">
										...
										<Columns>
											...
											<asp:BoundColumn DataField="pdpPlanCode" SortExpression="pdpPlanCode" HeaderText="計畫代碼">
											...
											<asp:BoundColumn DataField="dptName" SortExpression="dptName" HeaderText="部門名稱">
												<HeaderStyle Wrap="False" Width="200px"></HeaderStyle>
												<ItemStyle HorizontalAlign="Left"></ItemStyle>
											</asp:BoundColumn>
											<asp:BoundColumn Visible="False" DataField="pdpTeaCode" SortExpression="pdpTeaCode" HeaderText="pdpDepCode"></asp:BoundColumn>
											<asp:BoundColumn Visible="False" DataField="pdpOutlayYear" SortExpression="pdpOutlayYear" HeaderText="pdpOutlayYear"></asp:BoundColumn>
										</Columns>
									</asp:DataGrid>
								</td>
							</tr>
