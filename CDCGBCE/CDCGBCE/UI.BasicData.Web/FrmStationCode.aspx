							...
							<tr>
								<td>
									<table id="table6" style="WIDTH: 500px; HEIGHT: 168px" cellSpacing="0" cellPadding="1"
										border="0">
										<tr>
											<td align="right" width="89"><font style="FONT-SIZE: 11pt" face="新細明體">工作站代碼</font></td>
											<td width="158"><asp:TextBox id="TBID" runat="server" Width="100%" MaxLength="6"></asp:TextBox></td>
											<td align="right" width="83"><FONT style="FONT-SIZE: 11pt" face="新細明體">工作站代號</FONT></td>
											<td width="162"><asp:textbox id="TBNo" runat="server" Width="100%" MaxLength="20"></asp:textbox></td>
										</tr>
										<tr>
											<td align="right" width="89"><font style="FONT-SIZE: 11pt" face="新細明體">工作站名稱</font></td>
										...
										<tr>
											...
											<td style="WIDTH: 83px" align="right"><font style="FONT-SIZE: 11pt" face="新細明體">經辦人員</font></td>
												...
												<table id="table17" cellSpacing="0" cellPadding="0" border="0">
													<tr>
														...
														<td style="BORDER-LEFT: #edecf2 1px solid" vAlign="bottom" align="center"><asp:textbox id="TBSearchSql" onfocus="this.select()" onclick='this.value=""' runat="server"
																Width="96px" AutoPostBack="True">輸入工作站代碼</asp:textbox></td>
										...
										<tr>
											<td><asp:datagrid id="DataGrid1" runat="server" Width="100%" Height="72px" AllowPaging="True" CellPadding="3"
													...
													<Columns>
														...
														<asp:BoundColumn DataField="StationID" HeaderText="工作站代碼"></asp:BoundColumn>
														<asp:BoundColumn DataField="StationName" HeaderText="工作站名稱"></asp:BoundColumn>
														...
														<asp:BoundColumn Visible="False" DataField="DepID" HeaderText="部門代碼"></asp:BoundColumn>
													</Columns>
