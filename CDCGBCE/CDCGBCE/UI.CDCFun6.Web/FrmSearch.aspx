<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmSearch.aspx.vb" Inherits="UI.CDCFun6.Web.FrmSearch" %>
									...
									<asp:datagrid id="DataGrid1" runat="server" Width="100%" 
										...
										<Columns>
                                           <asp:TemplateColumn HeaderText="審核" Visible="false">
                                                ...
                                                <ItemTemplate   >
                                                    <asp:CheckBox ID="CBdgPass" runat="server" Checked='<%# iif( DataBinder.Eval(Container, "DataItem.PassFlag") &""="1", True, False) %>'  ToolTip='<%#  Val(DataBinder.Eval(Container, "DataItem.PassFlag") &"") %>' Enabled='<%# IIF(DataBinder.Eval(Container, "DataItem.PassFlag") &"" <>"" ,True, False) %>' />
                                                </ItemTemplate>
                                            </asp:TemplateColumn>              
                                            <asp:BoundColumn DataField="prjYear"   HeaderText="年度">
												<HeaderStyle Width="30px"></HeaderStyle>
											</asp:BoundColumn>
                                            <asp:TemplateColumn HeaderText="編輯" >
											    <HeaderStyle Width="40px"></HeaderStyle>
                                                <ItemTemplate   >
                                                    <asp:HyperLink ID="HLRptDtl"  Target="_blank"  NavigateUrl ='<%#   GetEditUrlTxt("workstatus=edit&acmWordNum=" & Container.DataItem("acmWordNum") & "&prjYear="& Container.DataItem("prjYear") & "&prjCaseNo="& Container.DataItem("prjCaseNo")) %>'  runat="server">編輯</asp:HyperLink>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>                                           
                                            ...
                                            <HeaderStyle Width="40px" Wrap="false"></HeaderStyle>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Image ID="Image1" runat="server" ImageUrl='<%#  "Images/" & IIF(Container.DataItem("DoneFlag") ="0" , "Cancel.gif", "OK.gif") %>' />
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateColumn HeaderText="廠商名稱" >
											    <HeaderStyle Width="40px"></HeaderStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="LBAcmPayName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PayName") %>'></asp:Label>                                                    
                                               </ItemTemplate>
                                            </asp:TemplateColumn>
                                            ...
                                            <HeaderStyle Width="90px" Wrap="false"></HeaderStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="LBdgAcvMoney" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.TotalMoney", "{0:#,0}") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            ...
                                            <HeaderStyle Width="50px" Wrap="false"></HeaderStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="LBdgPrjCaseKeys" runat="server"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
										</Columns>
