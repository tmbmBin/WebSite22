<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmSubsidyData.aspx.vb" Inherits="UI.CDCFun6.Web.FrmSubsidyData" %>
...
<script language="javascript" src="../ScriptFiles/JSStrFun.js" type="text/javascript"></script>
	<script language="javascript" type="text/javascript">
	    ...
	    function fnCallMemoDialog(thisName) {
	        ...
	        var strReturnVal = showModalDialog("../UI.CDCFun5.Web/FrmMemoPicker.aspx?rptflag=7&memokeys=" + document.getElementById("TBMemoKeys").value + "&", window, "dialogWidth:820px;dialogHeight:480px; dialogTop: px; dialogLeft: px; edge: Raised; center: Yes; help: No; resizable: Yes; status: Yes;");
...
<body>
    <form id="form1" runat="server">
        <input type="hidden" id="TBModFlag" runat="server" name="TBModFlag" /><input type="hidden" id="TBOrderTxt" runat="server" name="TBOrderTxt" /><input type="hidden" id="TBFindSql" runat="server" name="TBFindSql" />
    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <TM:FileUploadManagerX ID="FileUploadManagerX1" runat="server" EnableFileManage="True" EnableRemoveConfirm="true"
                                                                    ...
                                                                    <TM:FileUploadedList ID="FileUploadedList1" runat="server" Visible="false" />
                                            </td>
                                        </tr>
                                    </table></td>
							</tr>
