                                                                ...
                                                                <td align="right">
                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr>
                                                                            ...
                                                                            <td align="right" style="padding-left: 5px" nowrap>
                                                                                <asp:CheckBox ID="CBSecrearyFlag" runat="server" Font-Size="X-Small" TextAlign="Left" Text="秘書室審核" Visible="False" />
                                                                            </td>
                                                                            <td align="right" style="padding-left: 5px" nowrap>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr>
                                                                            <td id="trltd" style="padding-right: 5px" nowrap>
                                                                                <asp:CheckBox ID="CBAcmActKind" runat="server" Font-Size="X-Small" TextAlign="Right" Text="國外差旅" Style="display: none" onclick="ShowProdData();" /></td>
                                                                            <td style="padding-right: 5px" nowrap>
                                                                                <asp:CheckBox ID="CBAutoTempPay" runat="server" Font-Size="X-Small" TextAlign="Right" Text="逕行暫付" Style="display: none" onclick="ShowTmpPayData(this);chkTmpPayAndCash();" /></td>
                                                                            <td style="padding-right: 5px" nowrap>
                                                                                <asp:CheckBox ID="CBAutoBid" runat="server" Font-Size="X-Small" TextAlign="Right" Text="自動決標" Style="display: none" onclick="chkTmpPayAndCash();" /></td>
                                                                            <td style="padding-right: 5px" nowrap>
                                                                                <asp:CheckBox ID="CBAddVisa" runat="server" Font-Size="X-Small" TextAlign="Right" Text="加簽" Style="display: none" onclick="ShowAddVisaData(this);" /></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            </tr>
