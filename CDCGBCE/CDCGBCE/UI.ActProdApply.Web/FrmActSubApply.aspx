                                ...
                                <td style="text-align:right">
                                    <table cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                           ...
                                           <%-- <td style="padding-right: 5px" nowrap><asp:CheckBox ID="CBAutoTempPay" runat="server" Font-Size="X-Small" TextAlign="Right" Text="逕行暫付" Visible="True" onclick="ShowTmpPayData(this);" /></td>--%>
                                            <td style="padding-right: 5px" nowrap><asp:CheckBox ID="CBAutoTempPay" runat="server" Font-Size="X-Small" TextAlign="Right" Text="逕行預付" Visible="True" onclick="ShowTmpPayData(this);" /></td>
	                                        <td style="padding-right: 5px" nowrap><asp:CheckBox ID="CBAutoBid" runat="server" Font-Size="X-Small" TextAlign="Right" Text="自動決標" Visible="True" /></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
						...
						<table cellpadding="1" border="0">
							<tr>
								...
								<td valign="bottom" align="center">
                                    <input type="button" id="BtnPrint1" runat="server" style="width: 40px; height: 22px" value="列印"  visible="True" /><asp:button id="BtnPrint" runat="server" Text="列印" Height="22" Visible=false ></asp:button></td>
								<td valign="bottom" align="center">
                                    &nbsp;</td>
				...
				<tr>
					<td><asp:datagrid id="DataGrid1" runat="server" Width="100%" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True" PageSize="5">
									...
									<Columns>
										...
										<asp:BoundColumn Visible="False" DataField="M2Counter" HeaderText="M2Counter-10">
											<HeaderStyle Width="60px"></HeaderStyle>
										</asp:BoundColumn>
