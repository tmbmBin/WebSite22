                                        ...
                                        <asp:DataGrid ID="DataGrid2" runat="server" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="預算來源">
                                                    ...
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></ItemStyle>
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="DDLdgbgtSource" runat="server" Width="90" Style="background-color: #FFFFE0" MyName="DDLdgbgtSource" MyIndex='<%# Container.ItemIndex %>' onChange="showAcvBgtSourCnt(this.id);">
                                                        </asp:DropDownList>
                                                        <table id="TBAcvBgtSour" border="0" style="table-layout: fixed; border-collapse: collapse; font-size: 10px;">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="LBAcvBgtSourTitle" Style="display: none" runat="server" Text="次數："></asp:Label></td>
                                                                <td>
                                                                    <asp:TextBox ID="TBAcvBgtSourCnt" Style="display: none" runat="server" Width="30px" MyName="TBAcvBgtSourCnt" MyIndex='<%# Container.ItemIndex %>'></asp:TextBox></td>
                                                            </tr>
                                                        </table>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
