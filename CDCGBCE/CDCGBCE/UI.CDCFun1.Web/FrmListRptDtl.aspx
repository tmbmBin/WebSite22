<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmListRptDtl.aspx.vb" Inherits="UI.CDCFun1.Web.FrmListRptDtl" %>
     ...
     <link href="../CSSFiles/calendarStyle.css" type="text/css" rel="stylesheet">
		...
		<script language="javascript">
            ...
            function fnCallPayNameDtl(parObj) {
                showModalDialog(parObj.className, window, "dialogWidth:650px;dialogHeight:300px; dialogTop: px; dialogLeft: px; edge: Raised; center: Yes; help: No; resizable: Yes; status: Yes;");
										...
										<Columns>
											...
											<asp:TemplateColumn HeaderText="簽證資料">
                                                <HeaderStyle Width="60px" />
                                                 <ItemTemplate   >
                                                    <asp:HyperLink ID="HLDataDtl"  Target="_self"  NavigateUrl ='<%# GetUrlTxt(Container.DataItem("acmWordNum") &"",Container.DataItem("acmKidNum") &""  , val(Container.DataItem("acmYear") &""), val(Container.DataItem("acmNo") &"") , val( Container.DataItem("acmNo1") &"") , val(Container.DataItem("acmNo2")  &"") , val( Container.DataItem("acpPayYear")  &"") , val( Container.DataItem("acpPayNo") &"") , val( Container.DataItem("acpPayNo1") &""))  %>'    runat="server">簽證資料</asp:HyperLink>
