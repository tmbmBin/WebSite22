<%@ Page Language="vb" enableEventValidation="false" AutoEventWireup="false" CodeBehind="FrmNoExchNo.aspx.vb" Inherits="UI.CDCFun1.Web.FrmNoExchNo" %>
...
<head runat="server">
    <title>未命名頁面</title>
		...
		<script language="javascript">
		    ...
		    function checkMoney(parObj) {
		      var dblBMoney = parseFloat(replaceString(document.all("TBBMoney").value, ",", ""))
		    
		      var dblEMoney = parseFloat(replaceString(document.all("TBEMoney").value, ",", ""))
		    
		           
		        if (document.all("TBEMoney").value == "")
		        { document.all("TBEMoney").value=parObj.value}
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table style="TABLE-LAYOUT: fixed; MARGIN-TOP: 10px; MARGIN-LEFT: 10px; BORDER-COLLAPSE: collapse"
				borderColor="#666668" cellPadding="5" width="850" bgColor="#dadee9" border="1">
				<tr>
					<td>
								...
								<td>
									<table id="myTable" runat=server  style="table-layout:fixed" cellSpacing="0" cellPadding="5" width="100%" border="0">
										...
										<tr>
											...
											<td align="left" width="150" valign="top"><asp:dropdownlist id="DDLBizName" runat="server" Width="144px" ></asp:dropdownlist></td>
										</tr>
<tr>
...
<tr>
										...
										<tr>
											<td align="right" width="90"  >金額種類</td>
											<td ><asp:dropdownlist id="DDLMoneyKind" runat="server" Width="144px">
                                                <asp:ListItem Value="">------</asp:ListItem>
                                                <asp:ListItem Value="0">實支金額</asp:ListItem>
                                                <asp:ListItem Value="1">暫付金額</asp:ListItem>
                                                </asp:dropdownlist></td>
											<td align="right" width="90">不顯示明細</td>
											<td align="left" valign="top">
                                                <asp:CheckBox ID="CBShowDataType" runat="server" Checked="True" />
                                            </td>
											<td align="left" valign="top">&nbsp;</td>
										</tr>

										<tr>
											<td align="right" width="90" valign="top">金額範圍</td>
											<td colspan="3"  >大於<asp:TextBox ID="TBBMoney" runat="server" Width="100px" onkeypress="return check_Num()"></asp:TextBox>
                                                且小於<asp:TextBox ID="TBEMoney" runat="server" Width="100px" onkeypress="return check_Num()"></asp:TextBox></td>
											<td align="left" valign="top">&nbsp;</td>
										</tr>
